# -*- coding: utf-8 -*-
"""
Created on Tue Sep  8 16:39:13 2020

@author: lmun373
Sources: https://pypet.readthedocs.io/en/latest/examplesdoc/example_23.html
https://pypet.readthedocs.io/en/latest/examplesdoc/example_24.html
https://pypet.readthedocs.io/en/latest/manual/tutorial.html
...
def main():
    ...
    filename = os.path.join('hdf5', 'example_24.hdf5')
    env = Environment(trajectory='Example_24_BRIAN2',
                      filename=filename,
                      file_title='Example_24_Brian2',
                      comment = 'Go Brian2!',
    ...
    StateMon, Spikemon = postproc(traj, '.hdf5/example_24.hdf5')
    
    plt.plot(StateMon.vm[0], StateMon.t)
